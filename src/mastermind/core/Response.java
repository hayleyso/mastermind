...
/**
 * The Response class is responsible for handling the result of a guess 
 * compared to a given code in the Mastermind game.
 */
public class Response {
    ...
    /**
     * Constructor to generate the response 
     * and peg colors based on the comparison of the guess and the code.
     * 
